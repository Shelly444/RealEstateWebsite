...
*/
  ...
  global $conn;
    ...
    $description = "update a listing for our website";
    $banner = "Updating listing by agent";

    if(!isset($_GET['listing_id']) || !is_numeric($_GET['listing_id']) || !listing_exists($_GET['listing_id']))
    {
        $_SESSION['message'] = "The listing id does not exist";
...
<form  name="input" method="post" action=" <?php echo $_SERVER["PHP_SELF"] ?>"  >
	<h3 align="center">Listing Update</h3>
	<p align="left">This page is used for updating a listing.</p>
